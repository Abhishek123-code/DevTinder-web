...
//   // This holds the socket without triggering re-renders.
...
//     // 3. Assign the socket to the .current property of the ref.
//     // No state update, no re-render, no warning!
...
//   const sendMessage = () => {
//     // 4. Access the active socket using .current
//     if (!socketRef.current) return;

//     // 5. Emit using the ref
...
//       <div className="text-2xl border-b-2">Chat</div>
...
//       <div className="flex justify-center gap-2 mx-2 p-4">
//         <input
//           value={newMessage}
